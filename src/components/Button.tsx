...
export function Button({ children, variant = 'primary', href, onClick, className = '' }: ButtonProps) {
  ...
  const variants = {
    ...
    outline: 'bg-transparent text-[#1E2A45] border border-[#1E2A45] shadow-[0_1px_3px_rgba(30,42,69,0.1)] hover:bg-[#7A95AB]/10 hover:border-[#184A5A] hover:-translate-y-0.5 hover:shadow-[0_3px_6px_rgba(30,42,69,0.15)] active:translate-y-0 active:bg-[#7A95AB]/20 active:shadow-[0_1px_2px_rgba(30,42,69,0.08)]',
  };
